...
| Color settings     | <p>Consists of properties that allow you to change the style colors:</p><ul><li>Question color</li><li>Input color</li><li>Option color</li><li>Alternative option color</li><li>Disabled option color</li></ul> |
